...
#  library(httr)
  ...
  return(httr::POST(url="http://gateway.watsonplatform.net/natural-language-classifier/api/v1/classifiers",
...
watson.nlc.checkclassifierstatus <- function(classifier_id) {
  base_url_nlc = "https://gateway.watsonplatform.net/natural-language-classifier/api/v1/classifiers/"
  return(
    RCurl::getURL(paste(base_url_nlc,classifier_id,sep=""),userpwd = username_password_NLC)
  )
}
